...
#plays a specified sound effect from the sfx_clips dictionary
...
func _load_audio_settings():
	...
	set_master_volume(masterVolumeLevel)
	set_sfx_volume(sfxVolumeLevel)
	set_music_volume(musicVolumeLevel)
